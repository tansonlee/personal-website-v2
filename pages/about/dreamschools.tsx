		...
		>
			<Stack spacing={8}>
				<Text>
					...
					aiming to make children's programs more accessible to parents. Dreamschools is
				...
				<Box>
					...
					<Text>
						I implemented many features for the checkout system used by parents to pay
						for their children's programs. I added functionality for subscriptions, gift
						cards, refunds, coupons, taxes, and receipts for an improved experience for
						both parents and companies.
					</Text>
				</Box>
				<Box>
					...
					<Text>
						...
						reviewed all pull requests to ensure code quality and functionality. I also
						controlled all deployments to our staging and production environments. I
						worked closely with the CEO to advise business decitions from a techincal
						perspective.
					</Text>
				</Box>
				<Box>
					...
					<Text>
						...
						purposes. I also added dashboards to view per program analytics.
					</Text>
				</Box>
				...
				<Box>
					...
					<Text>
						I oversaw and updated a lot of developer infrastructure. I created
						deployment scripts which eliminated human error increasing uptime. I also
						modified the data storage hierchy to improve some page load times from 15
						seconds to under 500ms.
					</Text>
				</Box>
			</Stack>
		</AboutPageLayout>
